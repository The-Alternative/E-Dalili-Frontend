  ...
  >
      ...
      <div class="store" v-for="store in stores" :key="store.id">
        <div class="card-title row justify-content-lg-end">
          <div class="d-flex flex-row">
            <img class="img-open" src="@/assets/open.png" height="40" />
        ...
        <div class="card-footer">
          ...
          <div class="row img-button">
            <img class="Group" src="@/assets/Group.png" height="20" />
            <img class="MaskGroup" src="@/assets/MaskGroup.png" height="20" />
            <btnvisit-store></btnvisit-store>
    ...
    >
      ...
      <div class="card text-right checked-all open" id="all">
        ...
        <div class="checklist">
          <div class="">
            <label class="textcheck" for="check1">سوبر ماركت شوبيكو</label
            >&nbsp;
