<template>
    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 coler">
        <div class="content-pro text-center">
            <img @click="goto(id, title, description, price)"
             src="@/assets/w.jpg" class="new" />
            <div @click="goto(id, title, description, price)" class="name-prod">{{ title }}</div>
            <div @click="goto(id, title, description, price)" class="category">{{ description }}</div>
...
<div class="center">
  <div class="explainer"><span><i class="fa fa-shopping-cart"></i
            ></span></div>
