      ...
      <div class="container">
        ...
        <div class="row" style="width: 100%">
          ...
          <div class="col-lg-9 col-sm-8 col-xs-12">
            ...
            <!-- ------------------------------------------------------------ -->
            <div class="col-sm-1.5 imges" style="top: 600px" v-for="brand in brands.slice(4,5)" :key="brand.id" :image="brand.image">
              <img :src="`${urll}/${brand.image}`">
            </div>
            <div class="col-sm-1.5 imges" style="top: 800px" v-for="brand in brands.slice(5,6)" :key="brand.id" :image="brand.image">
              <img :src="`${urll}/${brand.image}`">
            </div>
            <div class="col-sm-9 imgs">
              <img :src="`${urll}/${brand.image}`" style="width: 100%" v-for="brand in brands.slice(6,7)" :key="brand.id" :image="brand.image"/>
            </div>
          </div>
        </div>
      </div>
